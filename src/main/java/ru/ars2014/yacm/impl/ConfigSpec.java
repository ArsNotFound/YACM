...
public class ConfigSpec extends UnmodifiableConfigWrapper<UnmodifiableConfig> implements IConfigSpec<ConfigSpec> {
    ...
    private ConfigSpec(UnmodifiableConfig storage, UnmodifiableConfig values, Map<List<String>, String> levelComments) {
        super(storage);
        this.values = values;
    ...
    public static class Builder {
        ...
        public ConfigSpec build() {
            ...
            ConfigSpec ret = new ConfigSpec(storage, valueCfg, levelComments);
